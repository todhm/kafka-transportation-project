...
class KafkaConsumer:
    ...
    def __init__(
        ...
        if is_avro is True:
            # client = CachedSchemaRegistryClient(SCHEMA_REGISTRY_URL)
    ...
    def on_assign(self, consumer, partitions):
        ...
        logger.fatal("partitions assigned for %s", self.topic_name_pattern)
    ...
    def _consume(self):
        ...
        if message is None:
            ...
            logger.fatal(f"error from consumer {message.error()}")
            return 0  
        else:
